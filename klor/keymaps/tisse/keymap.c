...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 //╷           ╷           ╷           ╷           ╷           ╷           ╷╷           ╷           ╷           ╷           ╷           ╷           ╷
    _________,  _________,  _________,  _________,  _________,                           _________,  KC_LPRN  ,  KC_RPRN  ,  KC_LBRC  ,  KC_RBRC  ,
    _________,  _________,  _________,  _________,  _________,                           KC_LEFT  ,  KC_DOWN  ,  KC_UP    ,  KC_RIGHT ,  _________,
    _________,  _________,  _________,  _________,  _________,  S(KC_W)  ,   _________,  _________,  KC_LBRC  ,  KC_RBRC  ,  _________,  _________,
